...
function scripts_site(){
    if( !is_admin() || !is_user_logged_in() ){
        ...
        wp_enqueue_script( 'datepicker.min', get_template_directory_uri() . '/js/libs/datepicker.min.js', array( 'jquery' ), '1.0', true );
        wp_enqueue_script( 'jquery-form-elements', get_template_directory_uri() . '/js/libs/jquery-form-elements.js', array( 'jquery' ), '1.0', true );
        wp_enqueue_script( 'datepicker.fr', get_template_directory_uri() . '/js/libs/i18n/datepicker.fr.js', array( 'jquery' ), '1.0', true );
        wp_enqueue_script( 'jquery.validate.min', get_template_directory_uri() . '/js/libs/jquery.validate.min.js', array( 'jquery' ), '1.0', true );
        wp_enqueue_script( 'styles.gmaps', get_template_directory_uri() . '/js/styles.gmaps.js', array( 'jquery' ), '1.0', true );
